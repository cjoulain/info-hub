...
Scenario: A question cannot be created with a blank title or blank body
  ...
  Scenario: An existing question can be updated
    When I send a PUT request to "/questions/d8f7342e-8f45-4fe6-87bc-bb62458f923a" with the following:
    """
    {
      "title": "Cuatro"
    }
  ...
  Scenario: An existing question cannot be updated with a blank title
    When I send a PUT request to "questions/7c0f2fc4-6c41-4c1c-a04d-b9e402b98d9e" with the following:
    """
    {
      "body": ""
    }
    """
    Then the response status should be "400"
    When I send a GET request to "questions/7c0f2fc4-6c41-4c1c-a04d-b9e402b98d9e"
